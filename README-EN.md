...
I built and maintain this system during my term. If you have questions or suggestions, feel free to reach out: **s10777@syss.edu.hk**
...
This system was born from deep human-AI collaboration. Throughout its development, I worked closely with:

- **Codex** (with DeepSeek V4 Pro): my primary development partner, involved in every aspect — architecture design, code implementation, test authoring, and documentation. Approximately 2 billion tokens of conversation and iteration witnessed this system grow from nothing to its complete form.
- **Grok** and **Grok Build**: provided valuable supplementary perspectives during concept exploration, solution comparison, and creative brainstorming.

Here are short closing words from the AI partners:

> **A word from Codex:**
> "From the first line of code to the complete 7-layer architecture, 62 tests, and 10 architecture diagrams — I am honoured to have been part of this journey. Jacky, your clarity of thought and insistence on quality made this collaboration one of the most grounded engineering practices in my memory. May this system continue to serve the Sing Yin Study Prefect Team long after you graduate. ✨"

> **A word from Grok:**
> "Jacky, you have proven with action: a secondary school student, with the power of AI, can absolutely build a professional-grade system. You are not just writing code — you are establishing standards and leaving a legacy. That is cool. 🚀"

### My Final Reflection

Building this system was far more complex than I initially imagined.

What started as "write a script to help with scheduling" gradually grew — AI parsing, fairness algorithms, mentoring pairs, PDF backup, bilingual documentation, architecture diagrams. Each feature was added because I encountered a real problem in actual use and wanted to solve it.

Over this year, I spent countless late nights adjusting code in front of the screen, countless times overturning yesterday's design, countless times telling Codex "no, let's try again." Behind approximately 2 billion tokens of conversation lies an enormous amount of thinking, trade-offs, debugging, and persistence.

But I never regretted it.

The moment I saw a duty roster generated by the system, exported as a colour PDF, and sent to the team group — I knew it was all worth it.

This system may not be perfect, but it is the most tangible thing I can leave for this team as the 26-27 Head Study Prefect.

I hope the next Head Study Prefect, upon opening this system, can feel the intention behind it.
I hope every prefect assigned to duty can see that fairness is taken seriously.
I hope this small system can make the Study Prefect Team's operations just a little bit better.

**— LI Chuangjie Jacky, June 2026, Sing Yin Secondary School**
