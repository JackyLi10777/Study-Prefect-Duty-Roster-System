...
The live public gateway currently identifies the deployed origin as `v1.2.0-rc.26` at commit `248955cb3300bfbe092b05036632991524d824cd`; its unchanged Worker record is `76a23134-8355-4e25-bbba-abf17c6918c5`. The 296-file runtime fingerprint is `5da902307e2d717a75c93e100ba9860eb7e6dd9c35dc42d4a1477bd3304de5e7`. rc26 completed exact-source verification, controlled Windows deployment and online rendered checks; the Worker was deliberately retained because its source and configuration were identical to rc24. Later source changes still require their own immutable evidence. Supervised Head Study Prefect and teacher-advisor acceptance remains a separate open decision until recorded.
...
- The current live baseline is bound to tag `v1.2.0-rc.26`, commit `248955cb3300bfbe092b05036632991524d824cd`, runtime fingerprint `5da902307e2d717a75c93e100ba9860eb7e6dd9c35dc42d4a1477bd3304de5e7`, and unchanged Worker `76a23134-8355-4e25-bbba-abf17c6918c5`. Supervised Head Study Prefect and teacher-advisor acceptance remains open. Any later runtime source change requires a new immutable candidate and exact deployment evidence; rc26 evidence cannot be reused to claim newer work is live.
