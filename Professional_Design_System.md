...
The live topology uses the `v1.2.0-rc.27` Windows origin at commit `c4c728aa41c9b0122aaa2c015b3cc38e246db43d` and rc29 Worker `d7b51f21-7692-418d-866c-034c2c57292d` at 100% traffic. The rc29 296-file fingerprint is `c015716b9594e0fb3d7cd313a824e5138e11ca389cd7de6f8f8fab8956ccd3bf`; it completed exact-source verification, staged Worker promotion and canonical entry／identity／Viewer checks without changing origin runtime. rc26 is the first-level origin rollback; previous Worker `76a23134-8355-4e25-bbba-abf17c6918c5` is the immediate gateway rollback. Later source changes still require their own immutable evidence. Supervised Head Study Prefect and teacher-advisor acceptance remains a separate open decision until recorded.
...
- The current production topology is intentionally split: the Windows NiceGUI origin remains on `v1.2.0-rc.27`／`c4c728aa41c9b0122aaa2c015b3cc38e246db43d`, while the canonical gateway runs rc29 Worker `d7b51f21-7692-418d-866c-034c2c57292d` at 100% traffic. Exact rc29 source is tagged `v1.2.0-rc.29` at `1fa3dfa85aa9ad6ef577e4c87c298cb11230ba1c` with fingerprint `c015716b9594e0fb3d7cd313a824e5138e11ca389cd7de6f8f8fab8956ccd3bf`; its staged and canonical checks do not claim a Windows-origin update. Supervised Head Study Prefect and teacher-advisor acceptance remains open. Any later runtime source change requires a new immutable candidate and exact deployment evidence.
