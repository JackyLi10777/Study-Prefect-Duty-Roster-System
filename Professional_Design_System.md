...
The recorded production topology is the clean annotated `v1.2.0-rc.31` Windows origin at commit `ba129a4931d11e844649e8ff356f5bf2ab048459` with canonical Worker `7816b183-3edb-49ca-b39b-a91091ae794f`. The current R7 remediation and B → A → C composition work remain a separate dirty working source: they have not been committed, tagged or deployed. The clean rc30 origin／Worker pair remains the immediate verified rollback, while older releases remain deeper recovery history. Runtime health, exact-source verification, controlled deployment and supervised Head Study Prefect／teacher-advisor acceptance are separate claims and must never be collapsed into one status.
...
- The verified live baseline is Windows origin and canonical gateway `v1.2.0-rc.30` at `74b84f43786b00feb15b51a6270ff71c9430773f`, with Worker version `11763f08-d40d-46d5-93dc-5ca2599d4154`. The first-level origin rollback remains rc27／`c4c728aa41c9b0122aaa2c015b3cc38e246db43d`, and the immediate Worker rollback remains `d7b51f21-7692-418d-866c-034c2c57292d`. rc31 is an undeployed comprehensive source candidate: earlier theme-only 901-test／8-browser-case results describe an older candidate slice and are historical, not exact-current-source release evidence. rc31 still requires current-source gates, a protected-main commit and tag, a formal verified backup and isolated restore, matched origin／Worker deployment evidence, canonical online checks, and supervised Head Study Prefect and teacher-advisor acceptance. Any later runtime source change requires a new immutable candidate and exact deployment evidence.
