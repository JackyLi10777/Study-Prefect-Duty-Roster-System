...
The operational topology currently requires provenance reconciliation: the Windows rc30 checkout was observed with 73 tracked modifications and 3 untracked items, and canonical Worker `a2e3ad14-d191-4ffc-85e4-eda40e42e5ed` has not been attributed to reviewed source. The clean `v1.2.0-rc.30` origin at commit `74b84f43786b00feb15b51a6270ff71c9430773f` with Worker `11763f08-d40d-46d5-93dc-5ca2599d4154` is the last fully verified clean pair. Its 296-file runtime fingerprint `15d155d8d745b14b574b08d793150c93aa77946e7d17a63030844c44adededbc`, exact-source verification, staged Worker promotion and canonical Public／Guest／Admin／Viewer checks remain historical clean-release evidence. `11763f08…` is the immediate known verified edge rollback; `d7b51f21…` and rc27 are older edge/origin recovery history. rc31 has passed 16 local rendered theme-continuity cases but remains unfrozen, untagged and undeployed until its own immutable evidence and paired deployment exist. Supervised Head Study Prefect and teacher-advisor acceptance remains a separate open decision until recorded.
