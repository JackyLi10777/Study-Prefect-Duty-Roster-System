...
> **目前候選界線：** rc23 runtime commit `4071cb55268c975302307fc40503c0b923562897`／fingerprint `a8f4483c32b17d9ef77b6df75968ef791a0a9cc0a8163b13b1b03acd3b3935de` 已完成 14／14 `--release` 等價正式驗證。其後只更新候選／線上事實的文件不會改變 runtime fingerprint，但仍須通過 docs／hygiene gate；tag、main、備份／還原、origin、Worker 與 canonical browser 全部完成前不可宣稱 rc23 已上線。
