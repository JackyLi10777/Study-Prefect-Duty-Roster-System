...
| 層 | 現況 |
|---|---|
| `C:\SingYinRoster` | clean annotated `v1.2.0-rc.40`／`2ec900a5ef1c021183717dfa648ef76b55452ffb`；298-file runtime fingerprint `e4e34ca75c422f823cfeb16e94c72705e1f73b8d56e6b2c6b953e102761a8f4c` 已對帳 |
| Cloudflare Worker／Access／Tunnel | canonical traffic 由受審 Worker `2cb38b05-6091-43be-86d3-d9f3ccae1ceb` 承接 100%；Access、Tunnel 與 OTP fail-closed 驗證已通過 |
| rc40 來源與部署證據 | 15／15 gate；受控 origin 切換、正式備份／隔離還原、canonical Admin／Guest 入口音樂及真實 Guest Dashboard checks 通過；Worker runtime 未變而刻意沿用 rc39 verified version |
| 第一個已驗證復原目標 | origin 使用 rc39 commit `80b9de7ea8abce57b67c6041e580f915a819315e`，edge 保留相容的 Worker `2cb38b05-6091-43be-86d3-d9f3ccae1ceb`；若 edge 本身故障，較深回退才使用 `d7069f99-81b4-4388-aa28-383b58bfc68f` |
...
1. 凍結候選、核對完整 report 與 fingerprint；候選必須先合併至 `main` 並建立新的獲批准 annotated tag；目前 rc40 origin／Worker 已對帳，任何新候選仍須產生自己的來源指紋及部署證據；
