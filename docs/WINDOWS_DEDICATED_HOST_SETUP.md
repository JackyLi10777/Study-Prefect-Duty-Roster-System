...
> **目前狀態（live rc23）：** `C:\SingYinRoster` 已固定於不可變標籤 `v1.2.0-rc.23`／`3432f1dd5381c4ddd8c2cd605437d290000af228`；第一級回退 `v1.2.0-rc.21`／`f7df4d0170e6bacd65340cc893992a17b5ed4aed`，rc20／`e3d84858abfe23714929a87c4bcf76e55999ce7c` 是次級已驗證基線。`Sing Yin Roster Host` 由非管理員 `SingYinRosterSvc` 帳戶運行；實際 loopback endpoint 由受保護 `.env` 的 `SING_YIN_HOST`／`SING_YIN_PORT` 決定，現為 `127.0.0.1:8080`。canonical Worker version `1bf0270d-5c78-462e-822b-f4a88e3956fa` 正承接 100% 流量；Tunnel、Public、Guest、Viewer 及 VPC health smoke 已核對。正式備份及隔離還原已通過。
>
