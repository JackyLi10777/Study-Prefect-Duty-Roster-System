...
> **Last fully verified clean v1.2 rc30 evidence:** the controlled Windows origin uses
...
> while rc27 is now the first-level origin rollback beneath the last verified clean rc30 origin described above.
