...
> **v1.2 rc17 現行交接狀態：**受控 Windows origin 正運行 annotated tag `v1.2.0-rc.17`／commit `99f5816`。288 個發布輸入以指紋 `4d412e6b40efadb8aee55e786f715eff0249fc363b755d938a75a7b1491e694d` 通過 14／14 正式 gate；正式備份 `20260722-002221-450041-manual_verified_backup.sqlite3`、SHA-256 `6c7b9502775decb80739676d43ccfe909fc41b09897c3037713e2f010358bfae`、公平對帳、行數核對、還原審計及隔離還原全部通過。canonical Worker version `c85770b2-c626-462c-bc74-5e6bd305c75b` 已通過 0% 候選及 100% 正式 smoke checks；origin 健康、ready，沒有待處理備份義務。rc15／`17a1cf9` 與 Worker `f8ea712c-6b64-4d32-8f62-3405bc313e24` 是即時回退組合；rc14、rc11 及更早數值只屬歷史發布證據。首席導學風紀及教師顧問仍須完成真人驗收清單。
...
3. Gate 通過後，才合併 `main` 並建立**下一個獲批准的 annotated tag**；不可預先重用任何既有標籤。保存目前 rc17／`99f5816` 作現行不可變版本，並保留 rc15／`17a1cf9` Windows bundle 及 Worker `f8ea712c-6b64-4d32-8f62-3405bc313e24` 作已記錄回退組合。
