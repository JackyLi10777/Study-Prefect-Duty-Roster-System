...
> **rc23 已完成 exact-source 機器驗證，但尚未上線：**commit `4071cb55268c975302307fc40503c0b923562897`／runtime fingerprint `a8f4483c32b17d9ef77b6df75968ef791a0a9cc0a8163b13b1b03acd3b3935de` 已通過 14／14 正式 gate，包括完整 Python suite、3 motion、40 Worker contract、桌面／手機／平板、效能、Admin／Guest、雙語 PDF、完整寫入／公平／交接／隔離還原及備份失敗復原。瀏覽器阻止迎賓音樂時，「安靜繼續」會保留並前往原定入口。Admin 支援事件只在明確同意後寫入隔離本機 inbox；Guest 支援摘要沒有發出網絡請求並在重新整理後消失。此證據不等於部署；建立 immutable tag、合併 protected main、正式備份／還原、Windows／Worker 配對切換及 canonical smoke 前，仍須以 rc21 作日常及回退基線。
