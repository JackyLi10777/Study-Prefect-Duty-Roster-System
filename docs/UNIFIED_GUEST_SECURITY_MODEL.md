...
The controlled Windows origin remains live on `v1.2.0-rc.26`／`248955cb3300bfbe092b05036632991524d824cd`, and Worker `76a23134-8355-4e25-bbba-abf17c6918c5` serves the canonical site. Exact rc26 passed all 14 formal gates with fingerprint `5da902307e2d717a75c93e100ba9860eb7e6dd9c35dc42d4a1477bd3304de5e7` and completed the controlled Windows switch. Worker source and protected configuration were unchanged from rc24, so that verified Worker remains in service. rc24 is the first rollback pair and rc21 is the secondary verified baseline.
