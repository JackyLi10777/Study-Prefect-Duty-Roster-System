...
Production currently runs clean `v1.2.0-rc.43`／`c8201f33e454d9120c73386642cbf9d737391466`; Worker `394e2205-ae8f-4eef-a13a-e701931e6f0d` serves 100% of canonical traffic. The bounded-receipt, write-boundary-expiry, semantic-motion, honest-waiting and R7 reliability changes are part of that verified source. The immediate paired rollback is rc41 commit `74072b0175ff64807312a8cc5b9cd016b6628210` with Worker `610092f6-59d4-4fd4-ab3a-3fbf1dd2c64e`. Supervised human acceptance remains open.
