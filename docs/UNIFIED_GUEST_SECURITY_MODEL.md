...
Production currently runs clean `v1.2.0-rc.35`／`570e29f745eef7c1995635d1b187021a8fec6ea4`; Worker `d7069f99-81b4-4388-aa28-383b58bfc68f` serves 100% of canonical traffic. The bounded-receipt, write-boundary-expiry and semantic-motion changes are part of that verified source. The immediate origin rollback is rc34 commit `8fd7ce46095f0b8ad8687bcb01ba60c6a8eab5d2`; the immediate edge rollback is Worker `7816b183-3edb-49ca-b39b-a91091ae794f`. Supervised human acceptance remains open.
