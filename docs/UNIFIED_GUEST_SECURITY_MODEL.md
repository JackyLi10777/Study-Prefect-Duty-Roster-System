...
The controlled Windows origin remains live on `v1.2.0-rc.27`／`c4c728aa41c9b0122aaa2c015b3cc38e246db43d`, and rc29 Worker `d7b51f21-7692-418d-866c-034c2c57292d` serves the canonical site at 100% traffic. Exact rc29 source (`v1.2.0-rc.29`／`1fa3dfa85aa9ad6ef577e4c87c298cb11230ba1c`) passed all 14 formal gates with fingerprint `c015716b9594e0fb3d7cd313a824e5138e11ca389cd7de6f8f8fab8956ccd3bf`, then completed staged smoke and canonical Public／Guest／Admin handoff／Viewer checks. rc26 is the first-level origin rollback; Worker `76a23134-8355-4e25-bbba-abf17c6918c5` is the immediate gateway rollback. Supervised human acceptance remains open.
