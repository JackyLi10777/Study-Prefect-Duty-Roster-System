...
> **目前狀態（2026-07-16）：** rc.16 的 `/`、`/guest`、`/try`、`/view#…`、Access 轉向及 VPC 健康已在正式網址通過 Worker、Python、PDF 與桌面／手機自動化核對。正式資料受控清理及管理員登入／登出、長時間重連、上載與 PDF 真人驗收仍須依本手冊完成，兩者不可與已上線的公開邊界混為一談。
