...
- Earlier 901／929 Python and eight-case direct Admin／Guest Chromium results remain historical candidate slices. The formal release-candidate run on 2026-07-29 passed all 15 gates for the 297-file source fingerprint `696e6079a2abe671ad09e73c15353491541cf2c74bbd5f205e4eef17939d1ff0`, including the complete Python suite, 48 Worker contracts, 16 rendered Public→Admin／Guest theme-continuity cases, desktop／mobile／tablet, write／PDF／fairness／backup／restore, Guest isolation, runtime growth and security checks.
