...
It follows the established _verify_*.py patterns (checks list of (bool, desc), ✅/❌ output, final PASSED/FAILED banner, explicit preservation notes for verse/gold).
...
try:
    ...
    checks.append((True, f"import app: limited in this env ({type(e).__name__}) — source + css checks sufficient"))
...
if all_pass:
    ...
    print("❌ DISPLAY VERIFICATION FAILED — review ❌ lines above.")
    sys.exit(1)
