...
ROUTE_MARKERS = {
    ...
    "/platform": ("[data-testid='platform-hero']", "[data-testid='platform-open-workspace']"),
    "/engineering": ("[data-testid='engineering-hero']", "[data-testid='engineering-release-state']"),
    "/system-architecture": (
        "[data-testid='architecture-open-platform']",
