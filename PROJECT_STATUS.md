...
The NiceGUI application now has a durable roster workflow and a unified multi-page operating structure. The latest refinement adds a bounded, reduced-motion-safe local GSAP presentation layer, paired Guide and Engineering atmosphere scenes, and opt-in semantic interaction cues without changing roster policy, persistence, or page availability.
